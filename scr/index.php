...
$auth_users = array(
    'APPRENTI' => '$2y$10$mKMtyh4pdxplSn/qd3taquadY/COv3DtLNp4e2YESSNBiJOJI.VKu',
    'COMPAGNON' => '$2y$10$5g4XMFubMNvGiodX5LRXS.vHjuYMg8mFWMsZyhjv/mdWiu0IXMV8i',
    'MAITRE' => '$2y$10$ictBxH0LFod/EXk9x9J4LO3.haJ8sp/rbUxog7KEW5F8IPOLbyHbu',
    'ORDRE1' => '$2y$10$55hVaIwdzwFzoyxTrhKdy.fROGfGl7B8vJ7tgTuKT1RJR17WBfQtS',
    'ORDRE2' => '$2y$10$xGjjO5EO5LpqEIIeYoY7iORxuUa.96YY9orU2JowNxDfFghknFUs2',
    'ORDRE3' => '$2y$10$xs7udwar8QX5QinQznjN2.lYw2MqKjdLJxcrvqAuWYjcAdIKX5T7S',
    'ORDRE4' => '$2y$10$SoU/TBs1CjAl4BhM0IpKfuuSC2Yxv5i7yfsed/ocehlcnIjq7.y7W',
    'GODAILLE' => '$2y$10$9lcLoiSPfwEtUXncbAFVgeNMCd.jCt/88Rr49LbjCcS16pdZt57fC'
);
...
$exclude_items = array('*.php', '*.json', '*.html',  '*.css', '*.js', '*.txt', '*.donx', '*.doc', '*.png', '*.jpg',  '*.xlsx', '*.xls' );
...
// Default language
$lang = isset($cfg->data['lang']) ? $cfg->data['lang'] : 'fr';
...
{
    try {
        $content = @file_get_contents('french.json');
        if ($content !== FALSE) {
